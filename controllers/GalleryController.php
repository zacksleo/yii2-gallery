...
namespace zacksleo\yii2\gallery\controllers;

use Yii;
use zacksleo\yii2\gallery\models\GalleryFile;
use zacksleo\yii2\gallery\models\Gallery;
use zacksleo\yii2\gallery\models\GallerySearch;
...
class GalleryController extends \yii\web\Controller
{
    ...
    public function actionUpload()
    {
        ...
        $baseDir = Yii::getAlias(Module::getInstance()->sourcePath);
